...
# $Header: http://ftp.pingwho.org/pub/gentoo/ftp/overlay/picoscope-overlay/dev-libs/pl1000/pl1000-2.0.0.1.570.ebuild revision 1 09/21/2018 jay Exp $

EAPI=5

inherit rpm

DESCRIPTION="PicoScope 1000 series Linux driver"
