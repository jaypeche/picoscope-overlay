...
# $Header: http://ftp.pingwho.org/pub/gentoo/ftp/overlay/picoscope-overlay/dev-libs/pswrappers/pswrappers-1.0.0.1.05.ebuild revision 1 09/21/2018 jay Exp $

EAPI=5

inherit rpm

DESCRIPTION="PicoScope Wrappers for series Linux driver"
