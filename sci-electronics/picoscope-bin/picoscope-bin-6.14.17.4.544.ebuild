...
RDEPEND="
	...
	=dev-libs/picoipp-1.3.0.4.29
	=dev-libs/usbdrdaq-2.0.34.1.2002
	=dev-libs/plcm3-2.0.17.1.1441
	=dev-libs/usbpt104-2.0.17.1.1441"

PDEPEND="
	scope_pl1000?	( =dev-libs/pl1000-2.0.34.1.2002 )
	scope_ps2000?	( =dev-libs/ps2000-3.0.34.3.2002 )
	scope_ps2000a?	( =dev-libs/ps2000a-2.1.34.5.2002 )
	scope_ps3000?	( =dev-libs/ps3000-4.0.34.3.2002 )
	scope_ps3000a?	( =dev-libs/ps3000a-2.1.34.6.2002 )
	scope_ps4000?	( =dev-libs/ps4000-2.1.34.2.2002 )
	scope_ps4000a?	( =dev-libs/ps4000a-2.1.34.2.2014 )
	scope_ps5000?	( =dev-libs/ps5000-2.1.34.3.2002 )
	scope_ps5000a?	( =dev-libs/ps5000a-2.1.34.6.2002 )
	scope_ps6000?	( =dev-libs/ps6000-2.1.34.6.2002 )
	scope_ps6000a?	( =dev-libs/ps6000a-1.0.34.0.2002 )"
